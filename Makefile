...
PROJECT_NAME       ?= shufflepop
RAYLIB_VERSION     ?= 3.5.0
RAYLIB_PATH        ?= /home/andrew/raylib
...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    EMSDK_PATH         ?= /home/andrew/emscripten
...
CFLAGS += -Wall -D_DEFAULT_SOURCE -Wno-missing-braces -Wno-narrowing -Wno-sign-compare -Wno-macro-redefined -g
...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    CFLAGS += -s USE_GLFW=3 -s TOTAL_MEMORY=16777216 -s ASYNCIFY=1 --preload-file resources -O2 --memory-init-file 0
...
PROJECT_SOURCE_FILES ?= shufflepop.cpp
